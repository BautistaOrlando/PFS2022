...
let salarioNro = rls.questionInt("Ingrese el numero de la lista en el que se encuadre su salario: ") // Ingrese un numero de la lista /
let salarioEnPesos = rls.questionFloat("Ingrese sus salario especifico en pesos ($) de acuerdo al intervalo del numero preseleccionado: " ) // Especifica el salario /

// Esta condicional determina a que intervalo pertenece el salario especifico, mostrando el nuevo salario, el aumento y advirtiendo en caso de ingresar numeros erroneos. Todo mediante la consola /
switch (salarioNro) {
    case (1): 
    ...
    case (4):
        ...
        console.log("Al su sueldo ser superior a los $25000 no recibio un aumento. Su sueldo es aún de: $" +salarioEnPesos)
        }
            else {
                console.log("Este numero no pertenece al intervalo")
            }
